document.addEventListener('DOMContentLoaded', function () {
    ...
    function mostraStarship(pagina = 1) {
        ...
        starshipsPorPagina.forEach(starship => {
            ...
            const urlImagenDefault = '../recursos/no-imagen.png';

            tarjetaStarship.innerHTML = `
            <div class="card starships-tarjeta">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-primary" data-url="${starship.url}">View details</button>
                </div>
            </div>
        `;
        ...
        document.querySelectorAll('.starships-tarjeta button').forEach(button => {
